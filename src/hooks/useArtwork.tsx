...
export const useArtwork = (tokenAddress: Address, tokenId: number) => {
  ...
  }, [tokenAddress, tokenId, getMasterArtSize, createGetLayerControlTokenValueFn, getLayersFromMetadata]);

  return { artElementRef, statusMessage, metadata, collector, error, layers: metadata?.layout.layers };
};
